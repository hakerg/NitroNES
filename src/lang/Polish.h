...
public:
    ...
    const char *tr(const char *id) const override {
        static const std::unordered_map<std::string, const char *> dict = {
            ...
            {"file.close", "Zamknij"},
            {"file.quit", "Wyjdź"},
            {"file.saveState", "Szybki zapis"},
            {"file.loadState", "Szybki odczyt"},
            {"emulation", "Emulacja"},
            ...
            {"settings.graphics.use_backdrop", "Użyj koloru tła gry jako tła okna"},
            {"settings.graphics.preserve_aspect", "Zachowaj proporcje"},
            ...
            {"controls.savestate", "Szybki zapis/odczyt"},
