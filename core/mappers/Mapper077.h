...
// ----------------------------------------------------------------------------
// PRG: 32 KB switchable. CHR: 2 KB ROM @ $0000-$07FF + 8 KB CHR-RAM @ $0800-$1FFF.
// Mirroring: four-screen (sprzetowo). Tutaj zwracamy FOURSCREEN.
...
public:
	...
	bool ppuMapWrite(uint16_t addr, uint32_t& mapped) override {
		if (addr >= 0x0800 && addr <= 0x1FFF) { mapped = addr; return true; }
		return false;
	}
